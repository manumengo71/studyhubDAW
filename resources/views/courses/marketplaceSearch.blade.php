...
@section('content')
    ...
    <div class="mb-10 animate-fade-in">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-display font-bold text-surface-900" id="cursos">Resultados de cursos</h2>
                <p class="text-sm text-surface-500 mt-1">Cursos que coinciden con tu búsqueda</p>
            </div>
            <a href="#categorias" class="btn-ghost text-sm">
                Ir a categorías
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @foreach ($temas as $tema)
                    @foreach ($coursesSearch->where('courses_categories_id', $tema->id) as $course)
                        <div class="course-card-modern group animate-slide-up" style="animation-delay: {{ $loop->parent->iteration * 0.03 + $loop->iteration * 0.03 }}s">
    ...
    {{-- Categories Results --}}
    <div class="mb-10 animate-fade-in" id="categorias">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-display font-bold text-surface-900">Resultado de categorías</h2>
                <p class="text-sm text-surface-500 mt-1">Categorías que coinciden con tu búsqueda</p>
            </div>
            <a href="#cursos" class="btn-ghost text-sm">
                Ir a cursos
        ...
        @else
            <div class="empty-state">
                ...
                <h3 class="text-lg font-bold text-surface-800 mb-1">Ningún resultado</h3>
                <p class="text-sm text-surface-500">No pudimos encontrar ninguna categoría que coincida con tu búsqueda.</p>
            </div>
        @endif
    </div>
