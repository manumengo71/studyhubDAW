    ...
    <x-slot name="slot">
        <div class="flex items-center justify-center p-12">
            <div class="mx-auto w-full">
                <form action="{{ route('mycourses.updateCourse', $courseInfo->id) }}" method="POST"
                    ...
                    <div class="flex justify-center">
                        <button type="button" onclick="window.location='{{ route('mycourses') }}'"
                                    ...
                                    @foreach ($lessons as $lesson)
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center">
                                                <form action="{{ route('editLesson', $lesson->id) }}" method="GET"
                                                    class="inline">
                                                    @csrf
                                                    @method('GET')
                                                ...
                                                <form action="{{ route('deleteLesson', $lesson->id) }}"
