    ...
    <div class="flex flex-wrap">
        @foreach ($temas as $tema)
            <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
                ...
                <div id="animation-carousel-{{ $tema->id }}" class="relative w-auto mx-4 mt-5 mb-5" data-carousel="static">
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        @foreach ($courses->where('courses_categories_id', $tema->id) as $course)
                            <div class="hidden duration-200 ease-linear group" data-carousel-item data-tema-id="{{ $tema->id }}">
